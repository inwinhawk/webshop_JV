...
(
	bestelling_ID BIGINT(8) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO Product VALUES (43, 'Men Leisure Swim Short zwart',' Dit is een tijdloze zwemshort van speedo. De modieuze Speedo Watershorts voor heren zitten vol geweldige technologie, en lenen zich perfect voor zwembad, strand en vakantie. Ze zijn gemaakt van een vochtafwerend en sneldrogend weefsel, zodat ze licht en droog blijven. Hierdoor zitten ze lekker en beweeg je je er gemakkelijk in. 
De short voelt droger en comfortabeler door water- en zandafvoerende zakken, en de elastische band zorgt voor een goede pasvorm. Deze watershorts zijn gemaakt van duurzaam weefsel, dus ze zijn zeer geschikt voor actief gebruik, zowel in als buiten het water. ',
 'Speedo', 'short','man', 21.00, 'images/producten/Short1.jpg'); 
 
INSERT INTO Product VALUES (44, 'Men Swim Short rood', 'Dit is een tijdloze zwemshort van speedo. De modieuze Speedo Watershorts voor heren zitten vol geweldige technologie, en lenen zich perfect voor zwembad, strand en vakantie. Ze zijn gemaakt van een vochtafwerend en sneldrogend weefsel, zodat ze licht en droog blijven. Hierdoor zitten ze lekker en beweeg je je er gemakkelijk in. 
De short voelt droger en comfortabeler door water- en zandafvoerende zakken, en de elastische band zorgt voor een goede pasvorm. Deze watershorts zijn gemaakt van duurzaam weefsel, dus ze zijn zeer geschikt voor actief gebruik, zowel in als buiten het water. ',
 'Speedo', 'short','man', 22.00, 'images/producten/Short2.jpg'); 
 
 
 /*INSERT INTO Klant (klant_ID, voornaam, naam, adres, gemeente,email,wachtwoord,admin);*/
-- Jeroen -> wachtwoord:root		Jef->wachtwoord:jef
...
/* INSERT INTO Bestelling (bestelling_ID, Klant_ID, besteldatum, Betaald);*/

-- INSERT INTO Bestelling VALUES (1 , 2, "2016-12-20", 1);
