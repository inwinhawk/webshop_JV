...
<head>
    <meta charset="UTF-8"/>
    <title>zwemkledij jongens</title>
...
<div id="content">
    ...
    <div>
		<ul id="soort">
					<li><a href="jongens.php">Alle producten</a></li>
					<li><a href="jongens.php?soort=slip">slip</a></li>
					<li><a href="jongens.php?merk=merk">merk &uarr; </a></li>
					<li><a href="jongens.php?prijs=prijs">prijs &darr; </a></li>
					<li><form action="#">
						<p>
	...
	<div id="Resultaten">
        ...
        //include hier connect.php == connectie met databank 
				...
				if(isset($_GET['soort']))
				{
						...
						$query = "SELECT productnaam,productbeschrijving,afbeelding,prijs,product_ID,merk,soort,categorie FROM product WHERE (soort = '".$_GET['soort']."') AND (categorie='jongen')";
				}
				elseif(isset($_GET['merk']))
				{
						...
						$query = "SELECT productnaam,productbeschrijving,afbeelding,prijs,product_ID,merk,soort,categorie  FROM product WHERE categorie='jongen' ORDER BY merk ASC ";
				...
				elseif(isset($_GET['prijs']))
				{
						...
						//enkel producten tonen van bepaald merk
						 $query = "SELECT productnaam,productbeschrijving,afbeelding,prijs,product_ID,merk,soort,categorie  FROM product WHERE categorie='jongen' ORDER BY prijs DESC ";
				}
				else
				{
                //Alle categorieën tonen (DISTINCT)
                 $query ="SELECT * FROM product where categorie='jongen'";
				}
                //Alle categorieën tonen (DISTINCT)
