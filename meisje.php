	...
	<div id="Resultaten">
        ...
        //include hier connect.php == connectie met databank 
				...
				if(isset($_GET['soort']))
				{
						...
						$query = "SELECT productnaam,productbeschrijving,afbeelding,prijs,product_ID,merk,soort,categorie FROM product WHERE (soort = '".$_GET['soort']."') AND (categorie='meisje')";
				}
				elseif(isset($_GET['merk']))
				{
						...
						$query = "SELECT productnaam,productbeschrijving,afbeelding,prijs,product_ID,merk,soort,categorie  FROM product WHERE categorie='meisje' ORDER BY merk DESC ";
				...
				elseif(isset($_GET['prijs']))
				{
						...
						//enkel producten tonen van bepaald merk
						 $query = "SELECT productnaam,productbeschrijving,afbeelding,prijs,product_ID,merk,soort,categorie  FROM product WHERE categorie='meisje' ORDER BY prijs DESC ";
				}
				else
				{
                //Alle categorieën tonen (DISTINCT)
                 $query ="SELECT * FROM product where categorie='meisje'";
				}
                //Alle categorieën tonen (DISTINCT)
